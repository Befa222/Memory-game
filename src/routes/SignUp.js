    ...
    <div className='form-container'>
      <h1>{error}</h1>
        <form className='form' onSubmit={handleSubmit}>
                ...
                <input onFocus={virtualKeyboardTrue} className='password' type="password" ref={passwordConfirmRef} required placeholder='Your password' />
                <input onFocus={virtualKeyboardTrue} className="submit-button" type="submit" disabled={loading} value="Sign In" />
        </form>
